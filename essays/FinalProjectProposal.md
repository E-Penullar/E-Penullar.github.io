...
layout: essay
type: essay
title: "Final Project Proposal — Agenda Planner"
...
Event Planners (Users) will be able to log in or sign up, set up a new event, edit events, and add more people to join their event. Events can be set up within a calender as a checklist with tasks, or as weekly, monthly, or yearly shindig to be mentioned on a calender.
